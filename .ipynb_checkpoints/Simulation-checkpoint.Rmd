...
\begin{center} \textbf{Bayesian Spatio-temporal Small Area Modeling: A Case Study of Estimating Late-Stage Melanoma Incidence in Texas.} \end{center}
...
mcmcConf$setMonitors('alpha_latent', 'alpha', 'xi', 'eta','include', 'delta', 'mu_delta', 'sigmasq_delta')
